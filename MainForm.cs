...
namespace HLNonBlockingExample.NET
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        public MainForm(string[] args)
        {
            ...
            foreach (NetworkInterface networkInterface in interfaces)
            {
                    ...
                    networkInterface.NetworkInterfaceType != NetworkInterfaceType.Tunnel)
                {
                    ...
                    // Get the unicast IP addresses assigned to the interface
                    ...
                    {
                        // Check if the IP address is an IPv4 address and not a link-local or loopback address
                            ...
                            !IPAddress.IsLoopback(ipAddress.Address))
                        {
                            ...
                            StartWebSocketServer($"http://{ipAddress.Address}:4466/");
                        }
                    }
                }
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.statusBar.Size = new System.Drawing.Size(1370, 22);
            ...
            this.ImagesTab.Size = new System.Drawing.Size(1354, 492);
            ...
            this.flowLayoutPanel1.Size = new System.Drawing.Size(1348, 489);
            ...
            this.tabControl.Size = new System.Drawing.Size(1362, 518);
                        ...
                        case MMM.Readers.FullPage.DataType.CD_SCBAC_STATUS:
                            {
                                MMM.Readers.Modules.RF.TriState lState = (MMM.Readers.Modules.RF.TriState)aData;
                                this.lblBACStatus.Text = lState.ToString();
                                Console.WriteLine("BAC ", lState.ToString());
                                break;
                            }
                        case MMM.Readers.FullPage.DataType.CD_SAC_STATUS:
                            {
        ...
        public async void StartWebSocketServer(string url)
        {
